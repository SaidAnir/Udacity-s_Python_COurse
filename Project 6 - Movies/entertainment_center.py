"""
THis program creates 6 instances of the Movie class
and then opens a web page containing them by calling the function
open_movies_page(movies) defined in fresh_tomatoes.py
...
# open the web page to show the movies
movies = [fight_club, matrix, point_break,usual_suspects, contact, apollo]
